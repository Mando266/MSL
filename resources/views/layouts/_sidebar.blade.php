<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionMenu">
            ...
            <li class="menu">
                <a href="{{route('users.index')}}" target="_blank" data-toggle="collapse" data-link="true" aria-expanded="true" class="dropdown-toggle">
                    <div class="">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample" style="padding:0px;">
             <li class="menu">
                        ...
                        <li>
                            <a href="#pages" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Ports & Terminals<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                ...
                                @permission('Ports-List')
                                    <li>
                                        <a href="{{route('ports.index')}}" target="_blank"> Ports </a>
                                    </li>
                                @endpermission

                                @permission('PortTypes-List')
                                    <li>
                                        <a href="{{route('port-types.index')}}" target="_blank"> Port Types </a>
                                    </li>
                                @endpermission
                                @permission('Terminals-List')
                                    <li>
                                        <a href="{{route('terminals.index')}}" target="_blank"> Terminals </a>
                                    </li>
                                @endpermission
                                </ul>
                        </li>
                        ...
                        <li>
                            <a href="#lines" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Lines <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                ...
                                @permission('Lines-List')
                                    <li>
                                        <a href="{{route('lines.index')}}" target="_blank"> Lines </a>
                                    </li>
                                @endpermission

                                @permission('LinesTypes-List')
                                    <li>
                                        <a href="{{route('line-types.index')}}" target="_blank"> Line Types </a>
                                    </li>
                                @endpermission
                                </ul>
                        </li>
                                ...
                                @permission('Suppliers-List')
                                    <li>
                                        <a href="{{route('suppliers.index')}}" target="_blank"> Suppliers</a>
                                    </li>
                                @endpermission

                                @permission('Customers-List')
                                    <li>
                                        <a href="{{route('customers.index')}}" target="_blank"> Customers</a>
                                    </li>
                                @endpermission
                        ...
                        <li>
                            <a href="#vessels" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Vessels <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                ...
                                @permission('Vessels-List')
                                    <li>
                                        <a href="{{route('vessels.index')}}" target="_blank"> Vessels </a>
                                    </li>
                                @endpermission

                                @permission('VesselsTypes-List')
                                    <li>
                                        <a href="{{route('vessel-types.index')}}" target="_blank"> Vessel Types </a>
                                    </li>
                                @endpermission
                                </ul>
                        </li>
                        <li>
                            <a href="#Containers" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Containers & Movements<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                ...
                                @permission('Containers-List')
                                    <li>
                                        <a href="{{route('containers.index')}}" target="_blank"> Containers </a>
                                    </li>
                                @endpermission

                                @permission('ContainersTypes-List')
                                    <li>
                                        <a href="{{route('container-types.index')}}" target="_blank"> Container Types </a>
                                    </li>
                                @endpermission
                                @permission('ContainersMovement-List')
                                    <li>
                                        <a href="{{route('container-movement.index')}}" target="_blank"> Movements codes </a>
                                    </li>
                                @endpermission

                                @permission('StockTypes-List')
                                    <li>
                                        <a href="{{route('stock-types.index')}}" target="_blank"> Stock Types </a>
                                    </li>
                                @endpermission
                                </ul>
                        </li>
                ...
                <li class="menu">
                <a href="{{route('voyages.index')}}" data-toggle="collapse" data-link="true" aria-expanded="true" class="dropdown-toggle" target="_blank">
                    <div class="">
