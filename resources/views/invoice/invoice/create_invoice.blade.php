                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker form-control" name="customer_id" id="customer"
                                        ...
                                        @endif
                                                <option
                                                    value="{{optional($bldraft)->customer_notifiy_id}}">{{ optional($bldraft->customerNotify)->name }}
                                                    Notify
                                                </option>
                                            @endif
                                            <option
                                                value="{{optional($bldraft)->customer_id}}">{{ optional($bldraft->customer)->name }}
                                                Shipper
                                            </option>
                                        @endif
                                    </select>
                                    ...
                                    <select class="selectpicker form-control" id="voyage_id" name="voyage_id"
                                        ...
                                        @foreach ($voyages as $item)
                                            @if(optional($bldraft)->voyage_id != null && optional($bldraft->booking)->transhipment_port == null)
                                                <option
                                                    value="{{$item->id}}" {{$item->id == old('voyage_id',$bldraft->voyage_id) ? 'selected':''}}>{{$item->vessel->name}}
                                            ...
                                            @elseif(optional($bldraft->booking)->voyage_id_second != null && optional($bldraft->booking)->transhipment_port != null)
                                                <option
                                                    value="{{$item->id}}" {{$item->id == old('voyage_id',$bldraft->booking->voyage_id_second) ? 'selected':''}}>{{$item->vessel->name}}
                                                    / {{$item->voyage_no}} - {{ optional($item->leg)->name }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="VAT %" name="vat"
                                           autocomplete="off" style="background-color:#fff" required>
                                </div>
                            </div>
                            <div class="form-row">
                                                    ...
                                                    <td>
                                                        <select class="selectpicker form-control"
                                                            ...
                                                            @foreach ($charges as $item)
                                                                <option
                                                                    value="{{$item->id}}" {{$detail->charge_type == old('charge_description',$item->id) ? 'selected':''}}>{{$item->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
