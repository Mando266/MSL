...
<table id="{{ $id ?? '' }}" {{ $attributes->merge(['class' => 'table table-bordered table-hover table-condensed mb-4']) }}>
    ...
    @foreach($rows ?? [] as $row)
        ...
        <td data-field="thc"><input type="text" name="rows[thc][]" class="form-control dynamic-input" data-field="thc_cost" value="{{ $row->thc }}"></td>
        <td data-field="storage"><input type="text" name="rows[storage][]" class="form-control dynamic-input" data-field="storage_cost" value="{{ $row->storage }}"></td>
        <td data-field="power"><input type="text" name="rows[power][]" class="form-control dynamic-input" data-field="power_cost" value="{{ $row->power }}"></td>
        <td data-field="power">
            <select style="min-width: 100px" class="form-control power-days">
                <option value="none" data-cost="0" selected>Normal</option>
                <option value="plus" data-cost="0">Plus One Day</option>
        ...
        <td data-field="shifting"><input type="text" name="rows[shifting][]" class="form-control dynamic-input" data-field="shifting_cost" value="{{ $row->shifting }}">
        </td>
        <td data-field="disinf"><input type="text" name="rows[disinf][]" class="form-control dynamic-input" data-field="disinf_cost" value="{{ $row->disinf }}"></td>
        <td data-field="hand-fes-em"><input type="text" name="rows[hand_fes_em][]" class="form-control dynamic-input"
                                            data-field="hand_fes_em" value="{{ $row->bl_no }}"></td>
        <td data-field="gat-lift-off-inbnd-em-ft40"><input type="text" name="rows[gat_lift_off_inbnd_em_ft40][]" class="form-control dynamic-input"
                                                           data-field="gat_lift_off_inbnd_em_ft40" value="{{ $row->gat_lift_off_inbnd_em_ft40 }}"></td>
        <td data-field="gat-lift-on-inbnd-em-ft40"><input type="text" name="rows[gat_lift_on_inbnd_em_ft40][]" class="form-control dynamic-input"
                                                          data-field="gat_lift_on_inbnd_em_ft40" value="{{ $row->gat_lift_on_inbnd_em_ft40 }}"></td>
        <td data-field="pti"><input type="text" name="rows[pti][]" class="form-control dynamic-input" data-field="pti_cost" value="{{ $row->pti }}"></td>
        <td data-field="pti">
            <select style="min-width: 100px" class="form-control pti-type" name="rows[pti_type][]">
                <option value="passed" data-cost="0" selected>Passed</option>
                <option value="failed" data-cost="0">Failed</option>
