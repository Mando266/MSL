                        ...
                        <form id="createForm" action="{{route('demurrage.store')}}" method="POST">
                            ...
                            <div>
                                <table id="period" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" id="period" name="period[0][period]" class="form-control"
                                                   autocomplete="off">
                                        </td>
                                        <td>
                                            <input type="text" id="rate" name="period[0][rate]" class="form-control"
                                                   autocomplete="off">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <select class="selectpicker form-control" id="containersTypesInput"
                                                    data-live-search="true" name="period[0][container_type_id]"
                                                    data-size="10"
                                                    title="{{trans('forms.select')}}" required>
