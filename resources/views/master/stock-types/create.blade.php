                ...
                <div class="widget-heading">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Containers Movement</a></li>
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);"> Add New Stock Type</a></li>
                            <li class="breadcrumb-item"></li>
                        </ol>
                    </nav>
                </div>
                <div class="widget-content widget-content-area">
                <form id="createForm" action="{{route('stock-types.store')}}" method="POST">
                        @csrf
                        <div class="form-row">
                       ...
                       <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <a href="{{route('stock-types.index')}}" class="btn btn-danger mt-3">{{trans('forms.cancel')}}</a>
                            </div>
                       </div>
