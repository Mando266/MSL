                    ...
                    <div class="widget-heading">
                        <nav class="breadcrumb-two" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="javascript:void(0);">Lines</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    ...
                                                    <li>
                                                        <a href="{{route('lines.edit',['line'=>$item->id])}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="edit">
                                                    ...
                                                    <li>
                                                        <form action="{{route('lines.destroy',['line'=>$item->id])}}" method="post">
                                                            @method('DELETE')
                                                            @csrf
